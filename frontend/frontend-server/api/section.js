...
export default{
  ...
  //分页讲师查询的方法
  getFrontSectionList(currentPage,pageSize,Queryset){
      return request({
          url: `/edu/sectionFront/getFrontSection/`,
          method: 'get',
  ...
  //课程详情查询
  getFrontSectionInfo(sectionId){
      return request(
          {
            url: `/edu/sectionFront/getFrontSectionInfo/${sectionId}`,
            method: 'get'
          }
      )
  }, 
