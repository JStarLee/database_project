<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item>
        <el-input v-model="teachQuery.section_id" placeholder="开课号" />
    </el-form-item>
          <el-form-item>
      <el-input v-model="teachQuery.teacher_id" placeholder="教师号" />
    </el-form-item>
    ...
    <el-table :data="list" border fit highlight-current-row>
      ...
      <el-table-column  prop="Teacher.tid" label="教师号" width="200" />
      <el-table-column  prop="Teacher.name" label="教师名" width="200" />

      <el-table-column  prop="status" label="状态" />

      <el-table-column  label="操作" width="300">
        <template slot-scope="scope">
        <!-- <router-link :to=" '/teach/edit/'+scope.row.id"> -->
...
import teach from "@/api/edu/teach";
export default {
  //写核心代码的位置
  ...
  methods: {
    //创建具体的方法，调用teach.js定义方法
    // 开课列表的方法
    //默认查第一页
    getList(page = 1) {
      this.page = page;
      teach
        .getTeachListPage(this.page, this.size, this.teachQuery)
        .then(response => {
          //请求成功
          //response接口返回的数据
